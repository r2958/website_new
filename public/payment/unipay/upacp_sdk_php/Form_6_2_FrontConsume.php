...
include_once getcwd().'/utf8/func/common.php';
include_once getcwd().'/utf8/func/SDKConfig.php';
include_once getcwd().'/utf8/func/secureUtil.php';
include_once getcwd().'/utf8/func/log.class.php';
$path = getcwd().'/../../../../application.php';
require_once($path);

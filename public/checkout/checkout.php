...
<table style="font-size:12px;">
	<tr>
		<td align="right" valign="middle">公司:</td>
		<td align="left"><input class="ipt" type="text" name="Company" size="45" value="<? $ShoppingCart->pv($order->Company); ?>"></td>
	</tr>
	<tr>
		<td align="right">联系人:<br />
			<br /></td>
		<td align="left">
			<table border="0" cellpadding="0" cellspacing="0" width="180">
				...
				<tr>
					<td align="left" valign="top"><input class="ipt" type="text" name="Title" size="5" value="<? $ShoppingCart->pv($order->Title); ?>" maxlength="5"></td>
					<td align="left" valign="top"><input class="ipt" type="text" name="FirstName" size="20" value="<? $ShoppingCart->pv($order->FirstName); ?>">
					...
					<td align="left" valign="top"><input  class="ipt" type="text" name="LastName" size="20"  value="<? $ShoppingCart->pv($order->LastName); ?>">
	...
	<tr>
		<td align="right" valign="middle"><b>邮箱:</b></td>
		<td align="left"><input class="ipt" type="text" name="Email" size="45" value="<? $ShoppingCart->pv($order->Email); ?>">
	...
	<tr>
		...
		<td align="left"><input class="ipt" type="text" name="Telephone" size="25" value="<? $ShoppingCart->pv($order->Telephone); ?>">&nbsp;<font size="-1">分机号: </font><input class='ipt' type="text" name="Extension" size="5" value="<? $ShoppingCart->pv($order->Extension); ?>">
	...
	<tr valign=top>
		...
		<td align="left"><input class="ipt" type="text" name="Fax" size="25" value="<? $ShoppingCart->pv($order->Fax); ?>"></td>
	</tr>
	<tr valign=top>
	...
	<tr>
		<td align="right" nowrap="nowrap"><b>收货地址:</b></td>
		<td align="left"><input class="ipt" type="text" name="BillingAddress" size="45" value="<? $ShoppingCart->pv($order->BillingAddress); ?>">
	...
	<tr>
		<td align="right" nowrap="nowrap"><b>所在地区:</b></td>
		<td align="left">
	...
	<tr>
		<td align="right" nowrap="nowrap"><b>邮政编码</b></td>
		<td align="left"><input class="ipt" type="text" name="BillingZip" size="45" value="<? $ShoppingCart->pv($order->BillingZip); ?>">
	...
	<tr>
		<td colspan="2" align="center" nowrap="nowrap">
			...
			<br />
			<b>收货地址</b><br />
			<input class="ipt" type="checkbox" name="ship_to_billing" value="CHECKED" onclick="javascript:checkboxSwap()"> - 和账单地址一样.</td>
	</tr>
	<tr>
		<td align="right" nowrap="nowrap">公司:</td>
		<td align="left"><input class="ipt" type="text" name="ShippingCompany" size="45" value="<? $ShoppingCart->pv($order->ShippingCompany); ?>"></td>
	</tr>
	<tr>
		<td align="right" nowrap="nowrap">收货地址:</td>
	...
	<tr>
		<td align="right" nowrap="nowrap">国家:</td>

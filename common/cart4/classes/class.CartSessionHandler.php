...
require_once('/home/andrew/work/ibscontrols/ibs-controls.com/common/functions/class.Neturf.php');
//require_once(Neturf::getServerRoot() . '/common/functions/class.SessionHandler.php');
require_once('/home/andrew/work/ibscontrols/ibs-controls.com/common/functions/class.SessionHandler.php');

			...
			<tr>
				<td bgcolor="black" height="25" class="noprint">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td class="whitetext">&copy; 1999-<?php echo date('Y'); ?>  <a href="http://www.neturf.com" target="_blank">Powered by andrew ren</a> &mdash; All Rights Reserved</td>
		...
		<?php if(@$ShowTopMenu != 'No' && file_exists($_SERVER['DOCUMENT_ROOT'] . '/admin/inc_menu.php')) { ?>
		...
		<div id="slideoutMenuContainer" class="noprint">
			<div id="slideoutMenuContent">
				<?php include($_SERVER['DOCUMENT_ROOT'] . '/admin/inc_menu.php'); ?>
			</div>
		</div>
		<?php } ?>
	</body>
